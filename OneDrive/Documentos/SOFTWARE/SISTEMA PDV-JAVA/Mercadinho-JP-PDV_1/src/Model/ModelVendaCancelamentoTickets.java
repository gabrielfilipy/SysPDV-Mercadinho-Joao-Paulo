...
* @author monet
*/
public class ModelVendaCancelamentoTickets {
    ...
    * Construtor
    */
    public ModelVendaCancelamentoTickets(){}
    ...
    */
    ...
    public void setHora(String hora) {
        ...
        public static String ELIMINAR_TUDO = "DELETE FROM tbl_venda_cancelamento_tickets";
