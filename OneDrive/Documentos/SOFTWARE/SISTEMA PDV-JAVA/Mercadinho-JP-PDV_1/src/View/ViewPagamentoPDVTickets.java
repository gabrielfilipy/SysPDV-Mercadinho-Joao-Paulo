 ...
 * @author Monet 
 */     
public class ViewPagamentoPDVTickets extends javax.swing.JDialog {
    ModelFormaPagamentoTickets model = new ModelFormaPagamentoTickets();
     ...
     */
    public ViewPagamentoPDVTickets(java.awt.Frame parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPagamentoPDVTickets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewPagamentoPDVTickets dialog = new ViewPagamentoPDVTickets(new javax.swing.JFrame(), true);
