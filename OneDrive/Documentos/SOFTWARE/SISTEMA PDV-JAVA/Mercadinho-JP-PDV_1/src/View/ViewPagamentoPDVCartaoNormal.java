 ...
 * @author Monet 
 */     
public class ViewPagamentoPDVCartaoNormal extends javax.swing.JDialog {
     ...
     */
    public ViewPagamentoPDVCartaoNormal(java.awt.Frame parent, boolean modal) {
    ...
    jcbPagamento.removeAllItems();
     ...
     private void calculandoPagamento(){ 
        tfRecebido.setText(tfSubTotal.getText());
        float desconto, subTotal, recebido=0, pagar, troco, dinheiro, recebidoDinheiro = 0, pagarDinheiro = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPagamentoPDVCartaoNormal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewPagamentoPDVCartaoNormal dialog = new ViewPagamentoPDVCartaoNormal(new javax.swing.JFrame(), true);
