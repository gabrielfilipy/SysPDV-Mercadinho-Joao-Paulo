...
public class ConexaoMySql2 { 
    ...
    private String nomeDoBanco = "sistem"; 
      
    
    //private String usuario = "ser"; 
    ...
    public ConexaoMySql2(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
    ...
    public Connection conectar(){
        try {
            ...
            JOptionPane.showMessageDialog(null, "Verifique se o servidor está ligado");
        }
        return this.getCon();
    }
